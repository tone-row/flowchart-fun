/*eslint-disable*/ module.exports = {
  messages: {
    ...
    Email: "E-mail",
    Empty: "Vazio",
    "Enter payment details": "Insira os detalhes de pagamento",
    ...
    "Shapes include rectangle, roundrectangle, ellipse, triangle, pentagon, hexagon, heptagon, octagon, star, barrel, diamond, vee, rhomboid, polygon, tag, round-rectangle, cut-rectangle, bottom-round-rectangle, and concave-hexagon.":
      "As formas incluem retângulo, retângulo arredondado, elipse, triângulo, pentágono, hexágono, heptágono, octógono, estrela, barril, diamante, vee, rombo, polígono, tag, retângulo arredondado, retângulo cortado, retângulo arredondado inferior e hexágono côncavo.",
    "Sign Up": "Inscreva-se",
    Size: "Tamanho",
    Small: "Pequeno",
    ...
    "You're almost there! Just one more step to unlock the full potential of Flowchart Fun Pro. Enter your payment details below to complete your subscription and start creating amazing flowcharts today.":
      "Você está quase lá! Só mais um passo para desbloquear o potencial total do Flowchart Fun Pro. Digite os detalhes de pagamento abaixo para completar sua assinatura e começar a criar fluxogramas incríveis hoje.",
