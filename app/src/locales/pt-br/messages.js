/*eslint-disable*/ module.exports = {
  messages: {
    ...
    "Certain attributes can be used to customize the appearance or functionality of elements.":
      "Certos atributos podem ser usados para personalizar a aparência ou funcionalidade dos elementos.",
    ...
    "Choose the plan that's right for you and start creating amazing flowcharts with Flowchart Fun Pro":
      "Escolha o plano certo para você e comece a criar incríveis fluxogramas com o Flowchart Fun Pro.",
    Circle: "Círculo",
    Classes: "Classes",
    Clay: "Argila",
    Clear: "Apagar",
    ...
    "Drag and drop a CSV file here, or click to select a file":
      "Arraste e solte um arquivo CSV aqui ou clique para selecionar um arquivo",
    "Draw an edge from multiple nodes by beginning the line with a reference":
      "Desenhe uma aresta de vários nós começando a linha com uma referência",
    "Drop the file here ...": "Solte o arquivo aqui ...",
    "Easily import existing flowcharts from other software":
      "Importe facilmente fluxogramas existentes de outros softwares",
    Edge: "Borda",
    "Edge ID, Classes, Attributes": "ID de Borda, Classes, Atributos",
    ...
    "Edges are declared in the same row as their target node":
      "As bordas são declaradas na mesma linha que seu nó de destino",
    "Edges are declared in their own row":
      "As bordas são declaradas em sua própria linha",
    "Edges can also have ID's, classes, and attributes before the label":
      "As bordas também podem ter ID's, classes e atributos antes da etiqueta",
    "Edges can be styled with dashed, dotted, or solid lines":
      "As bordas podem ser estilizadas com linhas tracejadas, pontilhadas ou sólidas",
    "Edges in Separate Rows": "Bordas em Linhas Separadas",
    "Edges in Source Node Row": "Bordas na Linha do Nó de Origem",
    "Edges in Target Node Row": "Bordas na Linha do Nó de Destino",
    Editable: "Editável",
    Editor: "Editor",
    Eggs: "Ovos",
    Email: "E-mail",
    ...
    "Essay writing process flowchart, guiding students through brainstorming, outlining, drafting, and revising stages":
      "Diagrama de fluxo da escrita de ensaios, orientando os alunos através das etapas de brainstorming, delineamento, elaboração e revisão.",
    "Everything in Free": "Tudo no Plano Gratuito",
    ...
    "Import data from a CSV file.": "Importar dados de um arquivo CSV.",
    "Import data from any CSV file and map it to a new flowchart. This is a great way to import data from other sources like Lucidchart, Google Sheets, and Visio.":
      "Importar dados de qualquer arquivo CSV e mapeá-los para um novo fluxograma. Esta é uma ótima maneira de importar dados de outras fontes, como Lucidchart, Google Sheets e Visio.",
    "Import from Lucidchart, Visio, and other CSV files":
      "Importar do Lucidchart, do Visio e de outros arquivos CSV",
    "Import your diagram it into Microsoft Visio using one of these CSV files.":
      "Importe seu diagrama para o Microsoft Visio usando um desses arquivos CSV.",
    "Important Changes are Coming to Flowchart Fun.":
      "Mudanças importantes estão chegando ao Flowchart Fun.",
    "Importing data is a pro feature. You can upgrade to Flowchart Fun Pro for just $3/month or $30/year.":
      "Importar dados é um recurso avançado. Você pode atualizar para o Flowchart Fun Pro por apenas US $ 3/mês ou US $ 30/ano.",
    "Impress your audience with high-quality images produced by Flowchart Fun":
      "Impressione sua audiência com imagens de alta qualidade produzidas pelo Flowchart Fun",
    "Include a title using a <0>title</0> attribute. To use Visio coloring, add a <1>roleType</1> attribute equal to one of the following:":
      "Inclua um título usando um atributo <0>title</0>. Para usar a coloração do Visio, adicione um atributo <1>roleType</1> igual a uma das seguintes opções:",
    ...
    Large: "Grande",
    Layout: "Layout",
    "Layout Frozen": "Layout Congelado",
    "Layout is Frozen": "O layout está congelado",
    "Leading References": "Principais Referências",
    "Learn More": "Saber mais",
    "Learn Syntax": "Aprender Sintaxe",
    "Learn about Flowchart Fun Pro": "Saiba mais sobre o Flowchart Fun Pro",
    ...
    "Let's get started! Enter your email address below to create your Flowchart Fun account and start using our powerful features.":
      "Vamos começar! Digite seu endereço de email abaixo para criar sua conta no Flowchart Fun e começar a usar nossos recursos poderosos.",
    Light: "Claro",
    ...
    "Lock Zoom to Graph": "Bloquear Zoom para o Gráfico",
    "Log In": "Acessar",
    "Log Out": "Deslogar",
    "Log in to start creating flowcharts.":
      "Faça o login para começar a criar fluxogramas.",
    ...
    "Make sure you use the same email you will use to log in.":
      "Certifique-se de usar o mesmo e-mail que você usará para fazer o login.",
    "Map Data": "Mapear Dados",
    "Market understanding and competitive landscape maintenance for SaaS product development":
      "Compreensão do mercado e manutenção do cenário competitivo para o desenvolvimento de produtos SaaS.",
    Medium: "Médio",
    Method: "Método",
    Monospace: "Monospace",
    Monthly: "Mensal",
    ...
    "No Edges": "Sem Bordas",
    Node: "Nó",
    "Node Border Style": "Estilo de Borda do Nó",
    "Node Colors": "Cores do Nó",
    "Node ID": "ID do Nó",
    ...
    "Only available on this device.<0/>Clearing your browser cache will erase them.":
      "Disponível apenas neste dispositivo.<0/>Limpar o cache do navegador irá apagá-los.",
    "Open Customer Portal": "Abra o portal do cliente",
    "Organization Chart": "Gráfico de Organização",
    ...
    "Process for corporate social responsibility initiatives development and implementation across company operations":
      "Processo para o desenvolvimento e implementação de iniciativas de responsabilidade social corporativa em todas as operações da empresa.",
    "Processing Data": "Processando Dados",
    Prompt: "Estímulo",
    Public: "Público",
    Random: "Aleatório",
    "Read-only": "Somente leitura",
    "Reference by Class": "Referência por Classe",
    "Reference by ID": "Referência por ID",
    "Reference by Label": "Referência por Rótulo",
    References: "Referências",
    "References are used to create edges between nodes that are created elsewhere in the document":
      "Referências são usadas para criar arestas entre nós que são criados em outro lugar no documento",
    "Referencing a node by its exact label":
      "Referenciando um nó pelo seu rótulo exato",
    "Referencing a node by its unique ID":
      "Referenciando um nó pelo seu ID único",
    ...
    Roadmap: "Roteiro",
    Save: "Salvar",
    "Save 20% (2 months free!)": "Economize 20% (2 meses grátis!)",
    "Save time and automate certain tasks with this cutting-edge feature":
      "Economize tempo e automatize certas tarefas com essa funcionalidade de ponta.",
    ...
    "Store any data associated to a node":
      "Armazenar quaisquer dados associados a um nó",
    ...
    "Streamline your workflow and simplify your process visualization with Flowchart Fun. Subscribe now and take advantage of our powerful Pro features!":
      "Simplifique seu fluxo de trabalho e simplifique sua visualização de processo com o Flowchart Fun. Assine agora e aproveite nossos poderosos recursos Pro!",
    Style: "Estilo",
    ...
    "Supply chain analysis and optimization: cost reduction, efficiency improvement, and stakeholder collaboration":
      "Análise e otimização da cadeia de suprimentos: redução de custos, melhoria da eficiência e colaboração com os stakeholders.",
    ...
    "Text followed by colon+space creates an edge with the text as the label":
      "Texto seguido de dois-pontos+espaço cria uma aresta com o texto como rótulo",
    "Text on a line creates a node with the text as the label":
      "Texto em uma linha cria um nó com o texto como rótulo",
    "Text sizes include small, regular, large, and extra-large.":
      "Os tamanhos de texto incluem pequeno, regular, grande e extra grande.",
    "Thank you for your feedback!": "Agradecimentos pelo seu feedback!",
    "The column that contains the edge label(s)":
      "A coluna que contém o(s) rótulo(s) da aresta",
    "The column that contains the source node ID(s)":
      "A coluna que contém o(s) ID(s) do nó de origem",
    "The column that contains the target node ID(s)":
      "A coluna que contém o(s) ID(s) do nó de destino",
    "The delimiter used to separate multiple source nodes":
      "O delimitador usado para separar vários nós de origem",
    ...
    "Use AI to generate a flowchart from a prompt. <0>Learn More</0>":
      "Use IA para gerar um fluxograma a partir de uma solicitação. <0>Saiba mais</0>.",
    "Use classes to group nodes": "Use classes para agrupar nós",
    "Use the attribute <0>href</0> to set a link on a node that opens in a new tab.":
      "Use o atributo <0>href</0> para definir um link em um nó que abra em uma nova guia.",
    "Use the attribute <0>src</0> to set the image of a node. The image will be scaled to fit the node, so you may need to adjust the width and height of the node to get the desired result. Only public images (not blocked by CORS) are supported.":
      "Use o atributo <0>src</0> para definir a imagem de um nó. A imagem será dimensionada para caber no nó, então você pode precisar ajustar a largura e altura do nó para obter o resultado desejado. Apenas imagens públicas (não bloqueadas por CORS) são suportadas.",
    "Use the attributes <0>w</0> and <1>h</1> to explicitly set the width and height of a node.":
      "Use os atributos <0>w</0> e <1>h</1> para definir explicitamente a largura e altura de um nó.",
    ...
    "Use this file for org charts, hierarchies, and other organizational structures.":
      "Use este arquivo para organogramas, hierarquias e outras estruturas organizacionais.",
    ...
    "Would you like to continue?": "Você gostaria de continuar?",
    Yearly: "Anualmente",
