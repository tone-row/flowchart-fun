/*eslint-disable*/ module.exports = {
  messages: {
    ...
    "Check your email for a link to log in.<0/>You can close this window.":
      "Vérifiez votre e-mail pour un lien de connexion. Vous pouvez fermer cette fenêtre.",
    ...
    "Click to preview": "Cliquez pour prévisualiser",
    Clone: "Cloner",
    Close: "Fermer",
    Color: "Couleur",
    ...
    Continue: "Continuer",
    "Convert this to a hosted chart?": "Convertir ceci en graphique hébergé?",
    ...
    "Create New Flowchart": "Créer un nouveau diagramme",
    ...
    "Customize your theme by editing the <0>Cytoscape CSS</0> below. Our styling documentation is coming soon! In the meantime, the best resource is the <1>Cytoscape</1> documentation. Come ask questions in the <2>Discord</2> if you get stuck.":
      "Personnalisez votre thème en modifiant le <0>Cytoscape CSS</0> ci-dessous. Notre documentation de mise en forme arrive bientôt ! Entre-temps, la meilleure ressource est la documentation <1>Cytoscape</1>. Venez poser des questions sur le <2>Discord</2> si vous êtes coincé.",
    Dark: "Sombre",
    ...
    Large: "Grand",
    Layout: "Disposition",
    "Layout Frozen": "Mise en page gelée",
    ...
    Link: "Lien",
    "Load Theme": "Charger le thème",
    "Loading a theme will erase any custom styles you have applied":
      "Charger un thème effacera tous les styles personnalisés que vous avez appliqués",
    "Lock Zoom to Graph": "Verrouiller le Zoom sur le Graphique",
    "Log In": "Connexion",
    "Log Out": "Déconnexion",
    ...
    "This document is only saved on this computer. If you want a way to store documents and access them wherever you go try our Pro plan for only $3/month!":
      "Ce document n'est sauvegardé que sur cet ordinateur. Si vous voulez un moyen de stocker des documents et de les consulter où que vous soyez, essayez notre plan Pro pour seulement 3 $/mois !",
    ...
    "This is a temporary chart, it will be deleted when you clear your browser cache.":
      "Il s'agit d'un graphique temporaire, il sera supprimé lorsque vous effacerez le cache de votre navigateur.",
    Tip: "Astuce",
    ...
    "To fix this start the container <0/> on a different line":
      "Pour corriger cela, commencez le conteneur <0/> sur une ligne différente.",
    ...
    "Use this file for org charts, hierarchies, and other organizational structures.":
      "Utilisez ce fichier pour les organigrammes, les hiérarchies et autres structures organisationnelles.",
    ...
    "Your subscription is no longer active. If you want to create and edit permanent charts upgrade to Pro.":
      "Votre abonnement n'est plus actif. Si vous souhaitez créer et modifier des graphiques permanents, passez à Pro.",
    "Zoom In": "Zoomer",
