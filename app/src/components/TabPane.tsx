  ...
  >
    <button
      className={classNames(
        "absolute top-1/2 left-[3px] -translate-x-1/2 p-1 rounded-full bg-[#f6f5f6] dark:bg-[#0c0c0c] text-neutral-500 hover:text-neutral-600 cursor-col-resize dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-200 dark:hover:bg-neutral-500 dark:hover:border-neutral-500",
        {
