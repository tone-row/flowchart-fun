...
>(function EditorActionTextButton(
  ...
  return (
    <button
      ref={ref}
      className={`p-1 text-left gap-2 text-[14px] text-blue-500 flex items-center gap-1 hover:text-blue-700 active:text-blue-800 focus:shadow-none dark:text-green-300 dark:hover:text-green-200 dark:active:text-green-200 ${className}`}
      {...props}
    >
